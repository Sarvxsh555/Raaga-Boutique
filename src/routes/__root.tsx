...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Raaga Boutique — Luxury Indian Couture" },
      { property: "og:description", content: "Raaga Boutique — premium sarees, kurtis, lehengas, bridal couture and bespoke design. Where heritage meets contemporary luxury." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Raaga Boutique — Luxury Indian Couture" },
      { name: "twitter:description", content: "Raaga Boutique — premium sarees, kurtis, lehengas, bridal couture and bespoke design. Where heritage meets contemporary luxury." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b80c4b07-2b8b-4c63-bf4a-f6c029baa6c5/id-preview-e1378a65--b41f0ada-0c1a-4682-9799-dce9d259920f.lovable.app-1781249712192.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b80c4b07-2b8b-4c63-bf4a-f6c029baa6c5/id-preview-e1378a65--b41f0ada-0c1a-4682-9799-dce9d259920f.lovable.app-1781249712192.png" },
    ],
    links: [
